...
export const PointSettingsModal: React.FC<PointSettingsModalProps> = ({
  ...
  // Breakpoints state (Primary daily task point system)
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    if (res.success) {
      setGlobalSaveMessage('Reward and rating point settings saved successfully!');
  ...
  return (
    <Modal
      ...
      subtitle="Configure daily review rating points and account rewards for SMM agents."
      size="xl"
    >
      <form onSubmit={handleSave} className="space-y-5 max-h-[80vh] overflow-y-auto pr-1">
        ...
        <div className="space-y-3">
          <div className="p-3.5 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 text-xs space-y-1.5">
            ...
            <p className="text-[11px] text-slate-300 leading-relaxed">
              Points awarded at midnight based on the SMM's daily average star rating (e.g. 5.0 ⭐ = 90 PTS, 4.5 ⭐ = 85 PTS, 4.0 ⭐ = 80 PTS).
            </p>
          </div>
        ...
        {/* 2. FACEBOOK ACCOUNT & WITHDRAWAL SETTINGS */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            ...
            <div>
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-xl glass-input text-xs font-bold text-amber-300"
                />
          ...
          <div className="glass-card rounded-2xl p-4 border border-slate-800 space-y-3">
            ...
            <p className="text-[11px] text-slate-400">
              Extra bonus points awarded automatically every time an SMM reaches the milestone target.
            </p>
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 rounded-xl glass-input text-xs font-bold text-amber-300"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 rounded-xl glass-input text-xs font-bold text-white"
                />
              </div>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-full px-3 py-1.5 rounded-xl glass-input text-xs font-bold text-indigo-300"
                  />
