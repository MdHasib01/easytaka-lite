...
export const NotificationDropdown: React.FC = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 sm:w-96 rounded-2xl bg-[#0B0F1A]/95 border border-slate-800 shadow-2xl backdrop-blur-2xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150">
          {/* Header */}
          ...
          {/* Filter Pills */}
          <div className="px-3.5 py-2 border-b border-slate-800/60 flex items-center gap-2 bg-slate-950/40 text-xs">
            <button
